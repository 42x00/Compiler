...
public interface LMxListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LMxParser#declarationSpecifier}.
	 * @param ctx the parse tree
	 */
	void enterDeclarationSpecifier(LMxParser.DeclarationSpecifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link LMxParser#declarationSpecifier}.
	 * @param ctx the parse tree
	 */
	void exitDeclarationSpecifier(LMxParser.DeclarationSpecifierContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link LMxParser#directDeclarator}.
	 * @param ctx the parse tree
	 */
	void enterDirectDeclarator(LMxParser.DirectDeclaratorContext ctx);
	/**
	 * Exit a parse tree produced by {@link LMxParser#directDeclarator}.
	 * @param ctx the parse tree
	 */
	void exitDirectDeclarator(LMxParser.DirectDeclaratorContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link LMxParser#compilationUnit}.
	 * @param ctx the parse tree
	 */
	void enterCompilationUnit(LMxParser.CompilationUnitContext ctx);
	/**
	 * Exit a parse tree produced by {@link LMxParser#compilationUnit}.
	 * @param ctx the parse tree
	 */
	void exitCompilationUnit(LMxParser.CompilationUnitContext ctx);
	/**
	 * Enter a parse tree produced by {@link LMxParser#translationUnit}.
	 * @param ctx the parse tree
	 */
	void enterTranslationUnit(LMxParser.TranslationUnitContext ctx);
	/**
	 * Exit a parse tree produced by {@link LMxParser#translationUnit}.
	 * @param ctx the parse tree
	 */
	void exitTranslationUnit(LMxParser.TranslationUnitContext ctx);
	/**
	 * Enter a parse tree produced by {@link LMxParser#externalDeclaration}.
	 * @param ctx the parse tree
	 */
	void enterExternalDeclaration(LMxParser.ExternalDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link LMxParser#externalDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitExternalDeclaration(LMxParser.ExternalDeclarationContext ctx);
	/**
